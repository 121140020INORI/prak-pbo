...
class AkunBank(ABC):
  ...
  def lihat_saldo(self):
    print(f"Akun atas nama {self.nama} memiliki saldo senilai {self.saldo}")
...
class AkunGold(AkunBank):
  ...
  def transfer_saldo(self, jumlah):
    if self.usia >= 3 and jumlah > 100000:
      print("Tidak Dikenakan Biaya Admin")
      self.saldo-=jumlah
    elif self.usia < 3 and jumlah > 100000:
      print("Biaya Admin Sebesar Rp. 2000")
...
Akun1=AkunGold("Inori", 2021, 5000000)
